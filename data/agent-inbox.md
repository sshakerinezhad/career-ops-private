...
**Answered 09-17 (later in session 12):** take-home is in the repo at `post-train/` (his copy of the Litmus repo, merged from origin/main; keep untouched); format-analysis §0.5 digests it, with numbers re-measured here (clean 16 salts +0.031, 16/16; poisoned 16 salts +0.041, 12/16, three banks lose 5 to 12 pts) and 12 questions Charlie could ask about it. GPU: only after the gate prep, optional. Toolkit: yes, public, ask Austin at kickoff (he did NOT ask Emily). Tools: Claude Code in terminal + Cursor editor; never built a full eval pipeline with an agent outside Litmus. Emily reply SENT 09-17 (corpus final logged, contact details redacted; deltas D018-D019): references given incl. current BMO supervisor; only the API-provider question was asked. Also merged from his other machine: `interview-prep/mercor-call-card.md` (screen card incl. Litmus §2 with his-vs-Claude authorship split) and `interview-prep/sessions/2026-09-09-mercor-screen.md` (a second, partial screen debrief that says James walked the Litmus and the call ran 30 min; conflicts with the 09-10 debrief's question list; unresolved).

**Next session:** get the five recorded walkthrough questions and resolve which screen debrief is right; agree or amend §4 priority split and §5 changes; then rebuild `mercor-onsite-plan.md` §6 day-by-day. `mercor-onsite-plan.md` §3 is superseded by the new file; everything else in it still stands until rebuilt. All session-11 open items below (Emily reply, keys, HF gate, mock friends, branch merges, career-ops update) are still open.
