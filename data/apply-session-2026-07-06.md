...
1. **FOLLOW-UPS: still 0 sent, now 3 OVERDUE** (OpenAI #3 pinned 07-14 → 25d late, OpenAI #4 pinned 07-21 → 18d late, METR #12 pinned 07-14 → 25d late; Figure #13 due 08-04 and Haize #22 due 08-06 come due within a week). Deferred four times now. Drafts from 2026-07-30 still unsent: ONE combined OpenAI message (Ashby merged #3+#4 into one candidate record), plus the METR draft that deliberately omits the "I misread L3, can I retake" ask — that stays held for a rejection reply. **Raise this before anything else; do not let a new application jump the queue again.**
