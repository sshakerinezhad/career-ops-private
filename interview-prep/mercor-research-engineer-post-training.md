...
**Open question from Kristen:** "Do you have any upcoming deadlines (offers, interviews, travel) we should know about?" Per Shayan 2026-09-10: BMO T&O offer is still live (current deadline not stated) and he is waiting on BMO CoE for a possible return offer; TMX letter unanswered; Mubit #61 Applied, no reply. Reply sent 2026-09-10 (corpus `mercor-32-onsite-reply-2026-09-10`): "working through a few other processes, wrap up by early October if possible"; offer not disclosed by his choice.
